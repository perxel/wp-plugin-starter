...
if ( $updated ) {
	\Perxel_Example\Admin::kit( \Perxel_UI::notice( 'success', esc_html__( 'Settings saved.', 'perxel-example' ), array( 'dismissible' => true ) ) );
} elseif ( $was_reset ) {
	\Perxel_Example\Admin::kit( \Perxel_UI::notice( 'success', esc_html__( 'Settings reset to defaults.', 'perxel-example' ), array( 'dismissible' => true ) ) );
}
